...
# Cross-chain zap (LI.FI) — Plan 4. Optional; safe to leave blank for now.
ARG NEXT_PUBLIC_RPC_URL_OPTIMISM
...
ENV NEXT_PUBLIC_WC_PROJECT_ID=$NEXT_PUBLIC_WC_PROJECT_ID \
    ...
    NEXT_PUBLIC_RPC_URL_OPTIMISM=$NEXT_PUBLIC_RPC_URL_OPTIMISM \
    NEXT_PUBLIC_LIFI_INTEGRATOR=$NEXT_PUBLIC_LIFI_INTEGRATOR \
